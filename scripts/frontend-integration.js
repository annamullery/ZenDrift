 ...
 * This file demonstrates how to integrate Zendrift with a web frontend
 */

// For React/Vue/Angular applications
export class ZendriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ZendriftClient(provider, contractAddress);
